...
**Saída esperada:**
Account data:
Number: 1234, Holder: Maria Silva, Balance: 750.00.

java
Copy code

**Caso de erro (exemplo):**
Enter amount for withdraw: 400.00
Withdraw error: The amount exceeds withdraw limit. (A quantia atingiu o limite de saque).
...
Account data:
Number: 1001, Holder: João Santos, Balance: 1000.00.
📚 Conceitos Aplicados
...
💡 Possíveis Melhorias
Adicionar opção de depósito via console
